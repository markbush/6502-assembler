...
object OpCodes {
  ...
  private val operations = Map(
    ADC -> Map(Immediate -> Op(0x69, 1), ZeroPage -> Op(0x65, 1), Absolute -> Op(0x6d, 2), AbsoluteIndexedX -> Op(0x7d, 2), AbsoluteIndexedY -> Op(0x79, 2), ZeroPageIndexedX -> Op(0x75, 1), ZeroPageIndirect -> Op(0x61, 1), ZeroPagePostIndexedIndirect -> Op(0x71, 1)),
    AND -> Map(Immediate -> Op(0x29, 1), ZeroPage -> Op(0x25, 1), Absolute -> Op(0x2d, 2), AbsoluteIndexedX -> Op(0x3d, 2), AbsoluteIndexedY -> Op(0x39, 2), ZeroPageIndexedX -> Op(0x35, 1), ZeroPageIndirect -> Op(0x21, 1), ZeroPagePostIndexedIndirect -> Op(0x31, 1)),
    ...
    CMP -> Map(Immediate -> Op(0xc9, 1), ZeroPage -> Op(0xc5, 1), Absolute -> Op(0xcd, 2), AbsoluteIndexedX -> Op(0xdd, 2), AbsoluteIndexedY -> Op(0xd9, 2), ZeroPageIndexedX -> Op(0xd5, 1), ZeroPageIndirect -> Op(0xc1, 1), ZeroPagePostIndexedIndirect -> Op(0xd1, 1)),
    ...
    DEC -> Map(ZeroPage -> Op(0xc6, 1), Absolute -> Op(0xce, 2), AbsoluteIndexedX -> Op(0xdd, 2), ZeroPageIndexedX -> Op(0xd6, 1)),
    ...
    LDA -> Map(Immediate -> Op(0xa9, 1), ZeroPage -> Op(0xa5, 1), Absolute -> Op(0xad, 2), AbsoluteIndexedX -> Op(0xbd, 2), AbsoluteIndexedY -> Op(0xb9, 2), ZeroPageIndexedX -> Op(0xb5, 1), ZeroPageIndirect -> Op(0xa1, 1), ZeroPagePostIndexedIndirect -> Op(0xb1, 1)),
    ...
    ORA -> Map(Immediate -> Op(0x09, 1), ZeroPage -> Op(0x05, 1), Absolute -> Op(0x0d, 2), AbsoluteIndexedX -> Op(0x1d, 2), AbsoluteIndexedY -> Op(0x19, 2), ZeroPageIndexedX -> Op(0x15, 1), ZeroPageIndirect -> Op(0x01, 1), ZeroPagePostIndexedIndirect -> Op(0x11, 1)),
    ...
    SBC -> Map(Immediate -> Op(0xe9, 1), ZeroPage -> Op(0xe5, 1), Absolute -> Op(0xed, 2), AbsoluteIndexedX -> Op(0xfd, 2), AbsoluteIndexedY -> Op(0xf9, 2), ZeroPageIndexedX -> Op(0xf5, 1), ZeroPageIndirect -> Op(0xe1, 1), ZeroPagePostIndexedIndirect -> Op(0xf1, 1)),
    SEC -> Map(Implied -> Op(0x38, 0)),
    SED -> Map(Implied -> Op(0xf8, 0)),
    SEI -> Map(Implied -> Op(0x78, 0)),
    STA -> Map(ZeroPage -> Op(0x85, 1), Absolute -> Op(0x8d, 2), AbsoluteIndexedX -> Op(0x9d, 2), AbsoluteIndexedY -> Op(0x99, 2), ZeroPageIndexedX -> Op(0x95, 1), ZeroPageIndirect -> Op(0x81, 1), ZeroPagePostIndexedIndirect -> Op(0x91, 1)),
